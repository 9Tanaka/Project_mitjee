...
const forbidden = /PrismaClient|@prisma\/|bcrypt|AUTH_SECRET|DATABASE_URL|MYSQL_TEST_DATABASE_URL|passwordHash|PrismaTrainingRepository|TrainingCore|credentialsAuthorize/;
