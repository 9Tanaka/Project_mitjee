...
import { playableTemplates } from "./catalog.js";
...
export async function createApplication(repository: TrainingRepository,
  ...
  const core = await TrainingCore.create([smsPhishingFixture, smsPhishingDialogueFixture, smsPhishingDecisionRulesFixture, ...playableTemplates], repository, now);
